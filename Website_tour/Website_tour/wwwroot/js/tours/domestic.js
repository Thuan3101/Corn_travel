$(document).ready(function () {
    ...
    async function loadDomesticTours(page = 1, pageSize = 2) {
        try {
            ...
            if (filteredTours.length > 0) {
                ...
                $('#domesticTours').append('<p>Không có tour nào thuộc loại này.</p>');
            }
        } catch (error) {
